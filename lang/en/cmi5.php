...
$string['packagemismatch:warningtitle'] = 'AU identifier mismatch detected';
$string['packagemismatch:warningbody'] = 'The following AUs in the uploaded package have different identifiers (IRIs) from the ones currently in this activity. They will be added as new AUs and existing learner progress will not be linked to them:';
$string['packagemismatch:recommendation'] = 'Recommendation: create a new activity for this version of the package to avoid mixing learner data between different AU identifiers.';
$string['packagemismatch:confirm'] = 'I understand that existing learner progress will not be linked to the new AUs, and I want to continue anyway.';
$string['packagemismatch:confirmerror'] = 'You must confirm that you understand the impact of mismatched AU identifiers before saving.';
