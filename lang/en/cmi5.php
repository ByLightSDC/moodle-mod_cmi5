...
$string['library:usageheading'] = '{$a->title} v{$a->version} usage';
$string['library:usageintro'] = 'This version is currently used by {$a} activities.';
$string['library:usageintro_one'] = 'This version is currently used by 1 activity.';
...
$string['library:backtopackage'] = 'Back to package';
